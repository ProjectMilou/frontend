...
describe('DashboardViewSelect', () => {
  ...
  test('show tooltips', async () => {
    ...
    fireEvent.mouseOver(container.children[0]);
    ...
    fireEvent.mouseOut(container.children[0]);
    act(() => {
      jest.runAllTimers();
    });
    ...
    fireEvent.mouseOver(container.children[1]);
    ...
    fireEvent.mouseOut(container.children[1]);
    act(() => {
      jest.runAllTimers();
    });

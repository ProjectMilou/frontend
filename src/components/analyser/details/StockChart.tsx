...
const Datetime: React.FC = () => 
  (
    ...
    <Button type='button' id="one_month" variant="contained" color= 'primary'
    
    onClick={()=>updateData('one_month')} className={ (state.selection==='one_month' ? 'active' : '')}>
    1M
    </Button>
    &nbsp;
    <Button type='button' id="six_months" variant="contained" color= 'primary'
    
    onClick={()=>updateData('six_months')} className={ (state.selection==='six_months' ? 'active' : '')}>
    6M
    </Button>
    &nbsp;
    <Button type='button' id="one_year" variant="contained" color= 'primary'
    ...
    &nbsp;
    <Button type='button' id="ytd" variant="contained" color= 'primary'
    
    onClick={()=>updateData('ytd')} className={ (state.selection==='ytd' ? 'active' : '')}>
    YTD
    </Button>
    &nbsp;
    <Button type='button' id="all" variant="contained" color= 'primary'
